...
export const verifyLogMembershipProof = ({ log, newUnpublishedRootHash, }) => {
...
export const verifyRecordMembershipProof = ({ record, root, }) => {
...
export const verifyLogConsistencyProof = ({ log, newUnpublishedRoot, prevUnpublishedRoot, }) => {
...
export const verifyRecordConsistencyProof = ({ publishedRoots, record, }) => {
...
export const verifySignature = (envelope) => {
