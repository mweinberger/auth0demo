...
exports.verifySignature = exports.verifyRecordConsistencyProof = exports.verifyLogConsistencyProof = exports.verifyRecordMembershipProof = exports.verifyLogMembershipProof = exports.verifyLogHash = void 0;
const crypto_js_1 = __importDefault(require("crypto-js"));
const merkle_tools_1 = __importDefault(require("merkle-tools"));
const signer_js_1 = require("../utils/signer.js");
...
const verifySignature = (envelope) => {
    ...
    if ((envelope === null || envelope === void 0 ? void 0 : envelope.signature) !== undefined &&
        (envelope === null || envelope === void 0 ? void 0 : envelope.public_key) !== undefined &&
        !envelope.public_key.startsWith("-----")) {
        var data = (0, utils_js_1.canonicalize)(envelope.event);
