...
(function (PangeaErrors) {
    ...
    class APIError extends Error {
        ...
        get errors() {
            var _a;
            return ((_a = this.response.result) === null || _a === void 0 ? void 0 : _a.errors) || [];
        }
    }
    ...
    class InternalServiceErrorError extends APIError {
        constructor(message, response) {
            super(message, response);
            this.name = "InternalServiceError";
        }
    }
    PangeaErrors.InternalServiceErrorError = InternalServiceErrorError;
...
})(PangeaErrors = exports.PangeaErrors || (exports.PangeaErrors = {}));
